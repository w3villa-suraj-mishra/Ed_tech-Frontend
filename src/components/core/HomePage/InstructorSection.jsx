...
const InstructorSection = () => {
  return (
    <div className='w-full max-w-[1260px] mx-auto my-6 px-4'>
      <div className='bg-[#0e111f] border border-blue-500/30 rounded-3xl p-8 sm:p-12 relative overflow-hidden shadow-[0_0_40px_rgba(37, 99, 235,0.15)] flex flex-col lg:flex-row items-center justify-between gap-12'>
        
        {/* Left Side: Instructor Image with Purple Glow Card */}
        <div className='lg:w-1/2 relative flex justify-center'>
          <div className='relative z-10 rounded-2xl overflow-hidden border border-blue-500/30 shadow-[0_0_30px_rgba(37, 99, 235,0.25)] max-w-md w-full aspect-[4/3] bg-blue-950/20'>
            <img
              src={Instructor}
          ...
          <div className="absolute inset-0 bg-blue-600/10 blur-3xl rounded-full -z-0"></div>
        </div>

        {/* Right Side: Copy & Actions */}
        <div className='lg:w-1/2 flex flex-col items-start gap-6 text-left'>
          
          <div className="inline-flex items-center gap-2 bg-blue-950/40 border border-blue-500/30 text-blue-300 text-xs font-extrabold uppercase tracking-wider px-3.5 py-1.5 rounded-full">
          ...
          <div className="grid grid-cols-2 gap-4 w-full pt-2">
            <div className="bg-[#141728] border border-white/5 p-3.5 rounded-2xl flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-blue-950/40 text-blue-400 flex items-center justify-center text-lg shrink-0">
                🎓
              </div>
              <div>
          ...
          <div className='pt-2'>
            <Link to="/signup">
              <button className='flex items-center gap-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-extrabold text-xs sm:text-sm px-6 py-3.5 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(37, 99, 235,0.4)] hover:shadow-[0_0_25px_rgba(37, 99, 235,0.6)] active:scale-95 group'>
