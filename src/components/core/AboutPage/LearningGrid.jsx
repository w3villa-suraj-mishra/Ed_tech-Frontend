...
const LearningGridArray = [
    ...
    },
    {
      ...
      description:
        "Save time and money! The Believable curriculum is made to be easier to understand and in line with industry requirements.",
    },
    {
      order: 2,
...
const LearningGrid = () => {
  return (
    <div className='grid mx-auto w-[100%] grid-cols-1 lg:grid-cols-4 mb-12'>
    {
