      ...
      <div className="max-w-[1260px] mx-auto space-y-20">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-950/40 border border-blue-500/30 text-blue-300 text-xs font-bold w-fit">
              <span>★</span>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight">
              ...
              <span className="text-[#3b82f6] block sm:inline">Brighter Future</span>
            </h1>
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center py-4">
            ...
            <div className="absolute -left-3 top-16 w-16 h-32 bg-[radial-gradient(#3b82f6_2px,transparent_2px)] [background-size:10px_10px] opacity-60 pointer-events-none"></div>
            <div className="absolute -right-3 bottom-8 w-24 h-24 bg-[radial-gradient(#3b82f6_2px,transparent_2px)] [background-size:10px_10px] opacity-60 pointer-events-none"></div>

            <div className="relative w-full max-w-[480px] h-[400px] sm:h-[440px]">
              
              {/* 1. TOP MAIN IMAGE CONTAINER WITH VIBRANT PURPLE GLOW SHADOW */}
              <div className="absolute top-0 left-0 w-[72%] h-[240px] sm:h-[270px] rounded-[24px] overflow-hidden border-2 border-[#b870ff] shadow-[0_0_40px_rgba(37, 99, 235,0.7),0_0_15px_rgba(37, 99, 235,0.9)] z-10">
              ...
              <div className="absolute top-[35px] right-0 z-30 bg-[#121124]/95 backdrop-blur-xl border border-blue-500/30 px-5 py-3.5 rounded-2xl shadow-[0_15px_35px_rgba(0,0,0,0.95),0_0_20px_rgba(37, 99, 235,0.35)] flex items-center gap-4 min-w-[200px]">
                <div className="w-10 h-10 rounded-xl bg-blue-600/30 flex items-center justify-center text-blue-400 text-xl shadow-[0_0_12px_rgba(37, 99, 235,0.4)]">
                  <FaUsers />
                </div>
              ...
              <div className="absolute bottom-0 left-0 w-[48%] h-[150px] sm:h-[165px] rounded-[20px] overflow-hidden border border-blue-500/40 shadow-[0_0_20px_rgba(37, 99, 235,0.35)] z-20">
              ...
              <div className="absolute bottom-0 right-0 w-[58%] h-[210px] sm:h-[235px] rounded-[24px] overflow-hidden border-2 border-[#b870ff] shadow-[0_0_40px_rgba(37, 99, 235,0.75),0_0_15px_rgba(37, 99, 235,0.9)] z-25">
        ...
        <section className="bg-[#0e1222]/90 border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl grid grid-cols-2 md:grid-cols-4 gap-6 text-center md:text-left">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:border-r border-white/10 pr-4">
            <div className="w-12 h-12 rounded-2xl bg-blue-600/20 text-blue-400 flex items-center justify-center text-xl shrink-0">
              <FaGraduationCap />
            </div>
            <div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 space-y-5 text-left">
            <span className="text-xs font-bold tracking-widest text-blue-400 uppercase">Our Journey</span>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Our Vision Card */}
          <div className="bg-[#0e1222]/90 border border-white/10 rounded-2xl p-8 text-left space-y-4 shadow-xl hover:border-blue-500/40 transition-all">
            <div className="w-14 h-14 rounded-full bg-blue-600/20 text-blue-400 flex items-center justify-center text-2xl border border-blue-500/30">
              <FaGlobe />
            </div>
            <span className="text-[11px] font-extrabold tracking-widest text-blue-400 uppercase block">Our Vision</span>
          ...
          <div className="bg-[#0e1222]/90 border border-white/10 rounded-2xl p-8 text-left space-y-4 shadow-xl hover:border-blue-500/40 transition-all">
            ...
            <span className="text-[11px] font-extrabold tracking-widest text-blue-400 uppercase block">Our Mission</span>
        ...
        <section className="space-y-12 text-center">
          <div>
            <span className="text-xs font-bold tracking-widest text-blue-400 uppercase block">What Makes Us Different</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mt-2">
              Our <span className="text-[#3b82f6]">Core Values</span> & Learning Approach
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 text-center">
            ...
            <div className="bg-[#0e1222]/90 border border-white/10 rounded-2xl p-6 flex flex-col items-center gap-4 hover:-translate-y-1.5 transition-all shadow-lg">
              <div className="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center text-lg shadow-md">
                <FaStar />
              </div>
